...
def upgrade() -> None:
    ...
    op.create_table(
        'table_execution',
        sa.Column('id', mysql.BINARY(16), nullable=False),  # UUID armazenado como BINARY(16)
    ...
    op.create_table('table_partition_exec',
    sa.Column('table_id', mysql.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.Column('tag_latest', mysql.TINYINT(display_width=1), server_default=sa.text("'0'"), autoincrement=False, nullable=False),
    ...
    sa.PrimaryKeyConstraint('table_id', 'partition_id', 'value'),
    mysql_collate='utf8mb4_general_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    )
