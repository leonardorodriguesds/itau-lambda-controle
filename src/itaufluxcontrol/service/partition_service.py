...
from src.itaufluxcontrol.models.dto.table_dto import PartitionDTO
from src.itaufluxcontrol.repositories.partition_repository import PartitionRepository
